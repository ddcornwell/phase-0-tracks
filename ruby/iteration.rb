...
puts ""
	...
	number = 0 
	new_hallywood_actors = {}
	
	number < hallywood_actors.length
	hallywood_actors.each do |actor, movie|
    ...
    # ==========================================
hallywood_actors = ["Jensen Ackles", "Christian Bale", "Nicolas Cage", "Eric Dane", "Nelsan Ellis" ]
puts ""
puts "Original data:"
puts ""
p hallywood_actors
